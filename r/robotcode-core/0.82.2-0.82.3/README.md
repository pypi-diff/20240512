# Comparing `tmp/robotcode_core-0.82.2.tar.gz` & `tmp/robotcode_core-0.82.3.tar.gz`
...
### Comparing `robotcode_core-0.82.2/pyproject.toml` & `robotcode_core-0.82.3/pyproject.toml`
