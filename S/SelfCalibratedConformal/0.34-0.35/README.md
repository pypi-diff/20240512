# Comparing `tmp/SelfCalibratedConformal-0.34.tar.gz` & `tmp/SelfCalibratedConformal-0.35.tar.gz`
...
## Comparing `SelfCalibratedConformal-0.34.tar` & `SelfCalibratedConformal-0.35.tar`
...
### Comparing `SelfCalibratedConformal-0.34/PKG-INFO` & `SelfCalibratedConformal-0.35/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.34/SelfCalibratedConformal.egg-info/PKG-INFO` & `SelfCalibratedConformal-0.35/SelfCalibratedConformal.egg-info/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.34/setup.py` & `SelfCalibratedConformal-0.35/setup.py`
