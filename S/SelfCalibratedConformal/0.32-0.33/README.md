# Comparing `tmp/SelfCalibratedConformal-0.32.tar.gz` & `tmp/SelfCalibratedConformal-0.33.tar.gz`
...
## Comparing `SelfCalibratedConformal-0.32.tar` & `SelfCalibratedConformal-0.33.tar`
...
### Comparing `SelfCalibratedConformal-0.32/PKG-INFO` & `SelfCalibratedConformal-0.33/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.32/SelfCalibratedConformal.egg-info/PKG-INFO` & `SelfCalibratedConformal-0.33/SelfCalibratedConformal.egg-info/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.32/setup.py` & `SelfCalibratedConformal-0.33/setup.py`
