# Comparing `tmp/qtharmony-0.2.0.tar.gz` & `tmp/qtharmony-0.2.1.tar.gz`
...
### Comparing `qtharmony-0.2.0/qtharmony/src/core/dialog.py` & `qtharmony-0.2.1/qtharmony/src/core/dialog.py`
