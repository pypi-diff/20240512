# Comparing `tmp/zetascale-2.4.5.tar.gz` & `tmp/zetascale-2.4.6.tar.gz`
...
### Comparing `zetascale-2.4.5/LICENSE` & `zetascale-2.4.6/LICENSE`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/README.md` & `zetascale-2.4.6/README.md`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/pyproject.toml` & `zetascale-2.4.6/pyproject.toml`
...
### Comparing `zetascale-2.4.5/zeta/__init__.py` & `zetascale-2.4.6/zeta/__init__.py`
...
### Comparing `zetascale-2.4.5/zeta/cli/main.py` & `zetascale-2.4.6/zeta/cli/main.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/cloud/main.py` & `zetascale-2.4.6/zeta/cloud/main.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/cloud/sky_api.py` & `zetascale-2.4.6/zeta/cloud/sky_api.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/experimental/triton/activations/__init__.py` & `zetascale-2.4.6/zeta/experimental/triton/activations/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/experimental/triton/activations/activations.py` & `zetascale-2.4.6/zeta/experimental/triton/activations/activations.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/experimental/triton/activations/functions.py` & `zetascale-2.4.6/zeta/experimental/triton/activations/functions.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/experimental/triton/triton_modules/linear_proj.py` & `zetascale-2.4.6/zeta/experimental/triton/triton_modules/linear_proj.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/LongNet.py` & `zetascale-2.4.6/zeta/models/LongNet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/__init__.py` & `zetascale-2.4.6/zeta/models/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/andromeda.py` & `zetascale-2.4.6/zeta/models/andromeda.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/beit3.py` & `zetascale-2.4.6/zeta/models/beit3.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/gpt4.py` & `zetascale-2.4.6/zeta/models/gpt4.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/kosmos.py` & `zetascale-2.4.6/zeta/models/kosmos.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/llama.py` & `zetascale-2.4.6/zeta/models/llama.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/max_vit.py` & `zetascale-2.4.6/zeta/models/max_vit.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/mega_vit.py` & `zetascale-2.4.6/zeta/models/mega_vit.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/mm_mamba.py` & `zetascale-2.4.6/zeta/models/mm_mamba.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/navit.py` & `zetascale-2.4.6/zeta/models/navit.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/palme.py` & `zetascale-2.4.6/zeta/models/palme.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/models/vit.py` & `zetascale-2.4.6/zeta/models/vit.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/__init__.py` & `zetascale-2.4.6/zeta/nn/attention/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/agent_attn.py` & `zetascale-2.4.6/zeta/nn/attention/agent_attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/attend.py` & `zetascale-2.4.6/zeta/nn/attention/attend.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/cross_attention.py` & `zetascale-2.4.6/zeta/nn/attention/cross_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/cross_attn_images.py` & `zetascale-2.4.6/zeta/nn/attention/cross_attn_images.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/dilated_attention.py` & `zetascale-2.4.6/zeta/nn/attention/dilated_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/flash_attention.py` & `zetascale-2.4.6/zeta/nn/attention/flash_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/linear_attention.py` & `zetascale-2.4.6/zeta/nn/attention/linear_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/linear_attn_l.py` & `zetascale-2.4.6/zeta/nn/attention/linear_attn_l.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/local_attention.py` & `zetascale-2.4.6/zeta/nn/attention/local_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/local_attention_mha.py` & `zetascale-2.4.6/zeta/nn/attention/local_attention_mha.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/mixture_attention.py` & `zetascale-2.4.6/zeta/nn/attention/mixture_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/multi_grouped_attn.py` & `zetascale-2.4.6/zeta/nn/attention/multi_grouped_attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/multi_modal_causal_attention.py` & `zetascale-2.4.6/zeta/nn/attention/multi_modal_causal_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/multi_modal_cross_attn.py` & `zetascale-2.4.6/zeta/nn/attention/multi_modal_cross_attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/multihead_attention.py` & `zetascale-2.4.6/zeta/nn/attention/multihead_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/multiquery_attention.py` & `zetascale-2.4.6/zeta/nn/attention/multiquery_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/scalable_img_self_attn.py` & `zetascale-2.4.6/zeta/nn/attention/scalable_img_self_attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/shaped_attention.py` & `zetascale-2.4.6/zeta/nn/attention/shaped_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/sparse_attention.py` & `zetascale-2.4.6/zeta/nn/attention/sparse_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/spatial_linear_attention.py` & `zetascale-2.4.6/zeta/nn/attention/spatial_linear_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/attention/xc_attention.py` & `zetascale-2.4.6/zeta/nn/attention/xc_attention.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/biases/alibi.py` & `zetascale-2.4.6/zeta/nn/biases/alibi.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/biases/dynamic_position_bias.py` & `zetascale-2.4.6/zeta/nn/biases/dynamic_position_bias.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/biases/relative_position_bias.py` & `zetascale-2.4.6/zeta/nn/biases/relative_position_bias.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/__init__.py` & `zetascale-2.4.6/zeta/nn/embeddings/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/abc_pos_emb.py` & `zetascale-2.4.6/zeta/nn/embeddings/abc_pos_emb.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/embedding.py` & `zetascale-2.4.6/zeta/nn/embeddings/embedding.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/multiway_network.py` & `zetascale-2.4.6/zeta/nn/embeddings/multiway_network.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/patch_embedding.py` & `zetascale-2.4.6/zeta/nn/embeddings/patch_embedding.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/pi.md` & `zetascale-2.4.6/zeta/nn/embeddings/pi.md`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/positional.py` & `zetascale-2.4.6/zeta/nn/embeddings/positional.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/positional_interpolation.py` & `zetascale-2.4.6/zeta/nn/embeddings/positional_interpolation.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/qfsp_embeddings.py` & `zetascale-2.4.6/zeta/nn/embeddings/qfsp_embeddings.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/qft_embeddings.py` & `zetascale-2.4.6/zeta/nn/embeddings/qft_embeddings.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/rope.py` & `zetascale-2.4.6/zeta/nn/embeddings/rope.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/scaled_sinusoidal_embeddings.py` & `zetascale-2.4.6/zeta/nn/embeddings/scaled_sinusoidal_embeddings.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/sine_positional.py` & `zetascale-2.4.6/zeta/nn/embeddings/sine_positional.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/sinusoidal.py` & `zetascale-2.4.6/zeta/nn/embeddings/sinusoidal.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/truncated_rope.py` & `zetascale-2.4.6/zeta/nn/embeddings/truncated_rope.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/vis_lang_emb.py` & `zetascale-2.4.6/zeta/nn/embeddings/vis_lang_emb.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/vision_emb.py` & `zetascale-2.4.6/zeta/nn/embeddings/vision_emb.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/xpos_relative_position.py` & `zetascale-2.4.6/zeta/nn/embeddings/xpos_relative_position.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/embeddings/yarn.py` & `zetascale-2.4.6/zeta/nn/embeddings/yarn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/masks/__init__.py` & `zetascale-2.4.6/zeta/nn/masks/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/masks/attn_masks.py` & `zetascale-2.4.6/zeta/nn/masks/attn_masks.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/masks/block_diagonal.py` & `zetascale-2.4.6/zeta/nn/masks/block_diagonal.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/README.md` & `zetascale-2.4.6/zeta/nn/modules/README.md`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/__init__.py` & `zetascale-2.4.6/zeta/nn/modules/__init__.py`
...
### Comparing `zetascale-2.4.5/zeta/nn/modules/_activations.py` & `zetascale-2.4.6/zeta/nn/modules/_activations.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/adaptive_conv.py` & `zetascale-2.4.6/zeta/nn/modules/adaptive_conv.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/adaptive_layernorm.py` & `zetascale-2.4.6/zeta/nn/modules/adaptive_layernorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/adaptive_parameter_list.py` & `zetascale-2.4.6/zeta/nn/modules/adaptive_parameter_list.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/adaptive_rmsnorm.py` & `zetascale-2.4.6/zeta/nn/modules/adaptive_rmsnorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/alr_block.py` & `zetascale-2.4.6/zeta/nn/modules/alr_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/attn.py` & `zetascale-2.4.6/zeta/nn/modules/attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/audio_to_text.py` & `zetascale-2.4.6/zeta/nn/modules/audio_to_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/avg_model_merger.py` & `zetascale-2.4.6/zeta/nn/modules/avg_model_merger.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/block_butterfly_mlp.py` & `zetascale-2.4.6/zeta/nn/modules/block_butterfly_mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/blockdiag_butterfly.py` & `zetascale-2.4.6/zeta/nn/modules/blockdiag_butterfly.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/chan_layer_norm.py` & `zetascale-2.4.6/zeta/nn/modules/chan_layer_norm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/clex.py` & `zetascale-2.4.6/zeta/nn/modules/clex.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/clip_bottleneck.py` & `zetascale-2.4.6/zeta/nn/modules/clip_bottleneck.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/cnn_text.py` & `zetascale-2.4.6/zeta/nn/modules/cnn_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/combined_linear.py` & `zetascale-2.4.6/zeta/nn/modules/combined_linear.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/conv_bn_relu.py` & `zetascale-2.4.6/zeta/nn/modules/conv_bn_relu.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/conv_mlp.py` & `zetascale-2.4.6/zeta/nn/modules/conv_mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/convnet.py` & `zetascale-2.4.6/zeta/nn/modules/convnet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/cross_embed_layer.py` & `zetascale-2.4.6/zeta/nn/modules/cross_embed_layer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/cross_modal_reparametization.py` & `zetascale-2.4.6/zeta/nn/modules/cross_modal_reparametization.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/decision_tree.py` & `zetascale-2.4.6/zeta/nn/modules/decision_tree.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/deepseek_moe.py` & `zetascale-2.4.6/zeta/nn/modules/deepseek_moe.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/dense_connect.py` & `zetascale-2.4.6/zeta/nn/modules/dense_connect.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/diffusion.py` & `zetascale-2.4.6/zeta/nn/modules/diffusion.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/droppath.py` & `zetascale-2.4.6/zeta/nn/modules/droppath.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/dual_path_block.py` & `zetascale-2.4.6/zeta/nn/modules/dual_path_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/dyna_conv.py` & `zetascale-2.4.6/zeta/nn/modules/dyna_conv.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/dynamic_module.py` & `zetascale-2.4.6/zeta/nn/modules/dynamic_module.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/dynamic_routing_block.py` & `zetascale-2.4.6/zeta/nn/modules/dynamic_routing_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/embedding_to_grid.py` & `zetascale-2.4.6/zeta/nn/modules/embedding_to_grid.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/ether.py` & `zetascale-2.4.6/zeta/nn/modules/ether.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/exo.py` & `zetascale-2.4.6/zeta/nn/modules/exo.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/expand_channels.py` & `zetascale-2.4.6/zeta/nn/modules/expand_channels.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/expert.py` & `zetascale-2.4.6/zeta/nn/modules/expert.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fast_text.py` & `zetascale-2.4.6/zeta/nn/modules/fast_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/feedback_block.py` & `zetascale-2.4.6/zeta/nn/modules/feedback_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/feedforward.py` & `zetascale-2.4.6/zeta/nn/modules/feedforward.py`
...
### Comparing `zetascale-2.4.5/zeta/nn/modules/feedforward_network.py` & `zetascale-2.4.6/zeta/nn/modules/feedforward_network.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/film.py` & `zetascale-2.4.6/zeta/nn/modules/film.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/film_conditioning.py` & `zetascale-2.4.6/zeta/nn/modules/film_conditioning.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/film_efficient_metb3.py` & `zetascale-2.4.6/zeta/nn/modules/film_efficient_metb3.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/flatten_features.py` & `zetascale-2.4.6/zeta/nn/modules/flatten_features.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/flex_conv.py` & `zetascale-2.4.6/zeta/nn/modules/flex_conv.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/flexible_mlp.py` & `zetascale-2.4.6/zeta/nn/modules/flexible_mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fractorial_net.py` & `zetascale-2.4.6/zeta/nn/modules/fractorial_net.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/freeze_layers.py` & `zetascale-2.4.6/zeta/nn/modules/freeze_layers.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fused_dropout_add.py` & `zetascale-2.4.6/zeta/nn/modules/fused_dropout_add.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fused_dropout_layernom.py` & `zetascale-2.4.6/zeta/nn/modules/fused_dropout_layernom.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fused_gelu_dense.py` & `zetascale-2.4.6/zeta/nn/modules/fused_gelu_dense.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/fusion_ffn.py` & `zetascale-2.4.6/zeta/nn/modules/fusion_ffn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/g_shard_moe.py` & `zetascale-2.4.6/zeta/nn/modules/g_shard_moe.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/gated_residual_block.py` & `zetascale-2.4.6/zeta/nn/modules/gated_residual_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/gill_mapper.py` & `zetascale-2.4.6/zeta/nn/modules/gill_mapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/glu.py` & `zetascale-2.4.6/zeta/nn/modules/glu.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/gru_gating.py` & `zetascale-2.4.6/zeta/nn/modules/gru_gating.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/h3.py` & `zetascale-2.4.6/zeta/nn/modules/h3.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/hebbian.py` & `zetascale-2.4.6/zeta/nn/modules/hebbian.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/highway_layer.py` & `zetascale-2.4.6/zeta/nn/modules/highway_layer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/image_projector.py` & `zetascale-2.4.6/zeta/nn/modules/image_projector.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/image_to_text.py` & `zetascale-2.4.6/zeta/nn/modules/image_to_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/img_or_video_to_time.py` & `zetascale-2.4.6/zeta/nn/modules/img_or_video_to_time.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/img_patch_embed.py` & `zetascale-2.4.6/zeta/nn/modules/img_patch_embed.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/img_reshape.py` & `zetascale-2.4.6/zeta/nn/modules/img_reshape.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/itca.py` & `zetascale-2.4.6/zeta/nn/modules/itca.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/kv_cache.py` & `zetascale-2.4.6/zeta/nn/modules/kv_cache.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/lambda_mask.py` & `zetascale-2.4.6/zeta/nn/modules/lambda_mask.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/lang_conv_module.py` & `zetascale-2.4.6/zeta/nn/modules/lang_conv_module.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/laser.py` & `zetascale-2.4.6/zeta/nn/modules/laser.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/layernorm.py` & `zetascale-2.4.6/zeta/nn/modules/layernorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/leaky_relu.py` & `zetascale-2.4.6/zeta/nn/modules/leaky_relu.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/log_ff.py` & `zetascale-2.4.6/zeta/nn/modules/log_ff.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/lora.py` & `zetascale-2.4.6/zeta/nn/modules/lora.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/matrix.py` & `zetascale-2.4.6/zeta/nn/modules/matrix.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mbconv.py` & `zetascale-2.4.6/zeta/nn/modules/mbconv.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mixtape.py` & `zetascale-2.4.6/zeta/nn/modules/mixtape.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mixtral_expert.py` & `zetascale-2.4.6/zeta/nn/modules/mixtral_expert.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mlp.py` & `zetascale-2.4.6/zeta/nn/modules/mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mlp_mixer.py` & `zetascale-2.4.6/zeta/nn/modules/mlp_mixer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mm_adapter.py` & `zetascale-2.4.6/zeta/nn/modules/mm_adapter.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mm_layernorm.py` & `zetascale-2.4.6/zeta/nn/modules/mm_layernorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mm_ops.py` & `zetascale-2.4.6/zeta/nn/modules/mm_ops.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/modality_adaptive_module.py` & `zetascale-2.4.6/zeta/nn/modules/modality_adaptive_module.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/moe.py` & `zetascale-2.4.6/zeta/nn/modules/moe.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/moe_router.py` & `zetascale-2.4.6/zeta/nn/modules/moe_router.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/monarch_mlp.py` & `zetascale-2.4.6/zeta/nn/modules/monarch_mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/mr_adapter.py` & `zetascale-2.4.6/zeta/nn/modules/mr_adapter.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/multi_input_multi_output.py` & `zetascale-2.4.6/zeta/nn/modules/multi_input_multi_output.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/multi_scale_block.py` & `zetascale-2.4.6/zeta/nn/modules/multi_scale_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/nebula.py` & `zetascale-2.4.6/zeta/nn/modules/nebula.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/nfn_stem.py` & `zetascale-2.4.6/zeta/nn/modules/nfn_stem.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/norm_fractorals.py` & `zetascale-2.4.6/zeta/nn/modules/norm_fractorals.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/norm_utils.py` & `zetascale-2.4.6/zeta/nn/modules/norm_utils.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/omnimodal_fusion.py` & `zetascale-2.4.6/zeta/nn/modules/omnimodal_fusion.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/p_scan.py` & `zetascale-2.4.6/zeta/nn/modules/p_scan.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/palo_ldp.py` & `zetascale-2.4.6/zeta/nn/modules/palo_ldp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/parallel_wrapper.py` & `zetascale-2.4.6/zeta/nn/modules/parallel_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/patch_linear_flatten.py` & `zetascale-2.4.6/zeta/nn/modules/patch_linear_flatten.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/patch_video.py` & `zetascale-2.4.6/zeta/nn/modules/patch_video.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/peg.py` & `zetascale-2.4.6/zeta/nn/modules/peg.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/perceiver_layer.py` & `zetascale-2.4.6/zeta/nn/modules/perceiver_layer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/perceiver_resampler.py` & `zetascale-2.4.6/zeta/nn/modules/perceiver_resampler.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/pixel_shuffling.py` & `zetascale-2.4.6/zeta/nn/modules/pixel_shuffling.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/poly_expert_fusion_network.py` & `zetascale-2.4.6/zeta/nn/modules/poly_expert_fusion_network.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/polymorphic_activation.py` & `zetascale-2.4.6/zeta/nn/modules/polymorphic_activation.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/polymorphic_neuron.py` & `zetascale-2.4.6/zeta/nn/modules/polymorphic_neuron.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/prenorm.py` & `zetascale-2.4.6/zeta/nn/modules/prenorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/proj_then_softmax.py` & `zetascale-2.4.6/zeta/nn/modules/proj_then_softmax.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/pulsar.py` & `zetascale-2.4.6/zeta/nn/modules/pulsar.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/pyro.py` & `zetascale-2.4.6/zeta/nn/modules/pyro.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/qformer.py` & `zetascale-2.4.6/zeta/nn/modules/qformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/qkv_norm.py` & `zetascale-2.4.6/zeta/nn/modules/qkv_norm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/quantized_layernorm.py` & `zetascale-2.4.6/zeta/nn/modules/quantized_layernorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/query_proposal.py` & `zetascale-2.4.6/zeta/nn/modules/query_proposal.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/recurrent_model.py` & `zetascale-2.4.6/zeta/nn/modules/recurrent_model.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/recursive_block.py` & `zetascale-2.4.6/zeta/nn/modules/recursive_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/res_net.py` & `zetascale-2.4.6/zeta/nn/modules/res_net.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/resnet.py` & `zetascale-2.4.6/zeta/nn/modules/resnet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/return_loss_text.py` & `zetascale-2.4.6/zeta/nn/modules/return_loss_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/rms_norm.py` & `zetascale-2.4.6/zeta/nn/modules/rms_norm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/rnn_nlp.py` & `zetascale-2.4.6/zeta/nn/modules/rnn_nlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/s4.py` & `zetascale-2.4.6/zeta/nn/modules/s4.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/scale.py` & `zetascale-2.4.6/zeta/nn/modules/scale.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/scale_norm.py` & `zetascale-2.4.6/zeta/nn/modules/scale_norm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/scaled_sinusoidal.py` & `zetascale-2.4.6/zeta/nn/modules/scaled_sinusoidal.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/scalenorm.py` & `zetascale-2.4.6/zeta/nn/modules/scalenorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/shift_tokens.py` & `zetascale-2.4.6/zeta/nn/modules/shift_tokens.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/shufflenet.py` & `zetascale-2.4.6/zeta/nn/modules/shufflenet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/sig_lip.py` & `zetascale-2.4.6/zeta/nn/modules/sig_lip.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/simple_feedforward.py` & `zetascale-2.4.6/zeta/nn/modules/simple_feedforward.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/simple_mamba.py` & `zetascale-2.4.6/zeta/nn/modules/simple_mamba.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/simple_res_block.py` & `zetascale-2.4.6/zeta/nn/modules/simple_res_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/simple_resblock.py` & `zetascale-2.4.6/zeta/nn/modules/simple_resblock.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/simple_rmsnorm.py` & `zetascale-2.4.6/zeta/nn/modules/simple_rmsnorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/skipconnection.py` & `zetascale-2.4.6/zeta/nn/modules/skipconnection.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/slerp_model_merger.py` & `zetascale-2.4.6/zeta/nn/modules/slerp_model_merger.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/sp_act.py` & `zetascale-2.4.6/zeta/nn/modules/sp_act.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/space_time_unet.py` & `zetascale-2.4.6/zeta/nn/modules/space_time_unet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/spacial_transformer.py` & `zetascale-2.4.6/zeta/nn/modules/spacial_transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/sparq_attn.py` & `zetascale-2.4.6/zeta/nn/modules/sparq_attn.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/sparse_moe.py` & `zetascale-2.4.6/zeta/nn/modules/sparse_moe.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/spatial_downsample.py` & `zetascale-2.4.6/zeta/nn/modules/spatial_downsample.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/spatial_transformer.py` & `zetascale-2.4.6/zeta/nn/modules/spatial_transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/splines.py` & `zetascale-2.4.6/zeta/nn/modules/splines.py`
...
### Comparing `zetascale-2.4.5/zeta/nn/modules/squeeze_excitation.py` & `zetascale-2.4.6/zeta/nn/modules/squeeze_excitation.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/ssm.py` & `zetascale-2.4.6/zeta/nn/modules/ssm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/ssm_language.py` & `zetascale-2.4.6/zeta/nn/modules/ssm_language.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/stoch_depth.py` & `zetascale-2.4.6/zeta/nn/modules/stoch_depth.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/stochastic_depth.py` & `zetascale-2.4.6/zeta/nn/modules/stochastic_depth.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/subln.py` & `zetascale-2.4.6/zeta/nn/modules/subln.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/super_resolution.py` & `zetascale-2.4.6/zeta/nn/modules/super_resolution.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/swarmalator.py` & `zetascale-2.4.6/zeta/nn/modules/swarmalator.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/swiglu.py` & `zetascale-2.4.6/zeta/nn/modules/swiglu.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/tensor.py` & `zetascale-2.4.6/zeta/nn/modules/tensor.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/tensor_to_int.py` & `zetascale-2.4.6/zeta/nn/modules/tensor_to_int.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/text_scene_fusion.py` & `zetascale-2.4.6/zeta/nn/modules/text_scene_fusion.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/text_video_fuse.py` & `zetascale-2.4.6/zeta/nn/modules/text_video_fuse.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/time_up_sample.py` & `zetascale-2.4.6/zeta/nn/modules/time_up_sample.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/to_logits.py` & `zetascale-2.4.6/zeta/nn/modules/to_logits.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/token_learner.py` & `zetascale-2.4.6/zeta/nn/modules/token_learner.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/token_mixer.py` & `zetascale-2.4.6/zeta/nn/modules/token_mixer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/top_n_gating.py` & `zetascale-2.4.6/zeta/nn/modules/top_n_gating.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/transformations.py` & `zetascale-2.4.6/zeta/nn/modules/transformations.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/triple_skip.py` & `zetascale-2.4.6/zeta/nn/modules/triple_skip.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/triton_rmsnorm.py` & `zetascale-2.4.6/zeta/nn/modules/triton_rmsnorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/u_mamba.py` & `zetascale-2.4.6/zeta/nn/modules/u_mamba.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/unet.py` & `zetascale-2.4.6/zeta/nn/modules/unet.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/v_layernorm.py` & `zetascale-2.4.6/zeta/nn/modules/v_layernorm.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/v_pool.py` & `zetascale-2.4.6/zeta/nn/modules/v_pool.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/video_autoencoder.py` & `zetascale-2.4.6/zeta/nn/modules/video_autoencoder.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/video_diffusion_modules.py` & `zetascale-2.4.6/zeta/nn/modules/video_diffusion_modules.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/video_to_tensor.py` & `zetascale-2.4.6/zeta/nn/modules/video_to_tensor.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/video_to_text.py` & `zetascale-2.4.6/zeta/nn/modules/video_to_text.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/vision_mamba.py` & `zetascale-2.4.6/zeta/nn/modules/vision_mamba.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/vision_weighted_permute_mlp.py` & `zetascale-2.4.6/zeta/nn/modules/vision_weighted_permute_mlp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/visual_expert.py` & `zetascale-2.4.6/zeta/nn/modules/visual_expert.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/vit_denoiser.py` & `zetascale-2.4.6/zeta/nn/modules/vit_denoiser.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/vss_block.py` & `zetascale-2.4.6/zeta/nn/modules/vss_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/ws_conv2d.py` & `zetascale-2.4.6/zeta/nn/modules/ws_conv2d.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/xmoe/global_groups.py` & `zetascale-2.4.6/zeta/nn/modules/xmoe/global_groups.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/xmoe/moe_layer.py` & `zetascale-2.4.6/zeta/nn/modules/xmoe/moe_layer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/xmoe/routing.py` & `zetascale-2.4.6/zeta/nn/modules/xmoe/routing.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/nn/modules/yolo.py` & `zetascale-2.4.6/zeta/nn/modules/yolo.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/__init__.py` & `zetascale-2.4.6/zeta/ops/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/async_softmax.py` & `zetascale-2.4.6/zeta/ops/async_softmax.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/dilated_attn_ops.py` & `zetascale-2.4.6/zeta/ops/dilated_attn_ops.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/einops_from_to.py` & `zetascale-2.4.6/zeta/ops/einops_from_to.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/einops_poly.py` & `zetascale-2.4.6/zeta/ops/einops_poly.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/expand.py` & `zetascale-2.4.6/zeta/ops/expand.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/laplace.py` & `zetascale-2.4.6/zeta/ops/laplace.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/main.py` & `zetascale-2.4.6/zeta/ops/main.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/misc_act.py` & `zetascale-2.4.6/zeta/ops/misc_act.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/mm_rearranges.py` & `zetascale-2.4.6/zeta/ops/mm_rearranges.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/mm_softmax.py` & `zetascale-2.4.6/zeta/ops/mm_softmax.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/mos.py` & `zetascale-2.4.6/zeta/ops/mos.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/nonlinear.py` & `zetascale-2.4.6/zeta/ops/nonlinear.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/softmax.py` & `zetascale-2.4.6/zeta/ops/softmax.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/ops/sparsemax.py` & `zetascale-2.4.6/zeta/ops/sparsemax.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/__init__.py` & `zetascale-2.4.6/zeta/optim/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/batched_optimizer.py` & `zetascale-2.4.6/zeta/optim/batched_optimizer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/decoupled_lion.py` & `zetascale-2.4.6/zeta/optim/decoupled_lion.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/decoupled_optimizer.py` & `zetascale-2.4.6/zeta/optim/decoupled_optimizer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/decoupled_sophia.py` & `zetascale-2.4.6/zeta/optim/decoupled_sophia.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/gradient_ascent.py` & `zetascale-2.4.6/zeta/optim/gradient_ascent.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/gradient_equillibrum.py` & `zetascale-2.4.6/zeta/optim/gradient_equillibrum.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/lion8b.py` & `zetascale-2.4.6/zeta/optim/lion8b.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/parallel_gradient_descent.py` & `zetascale-2.4.6/zeta/optim/parallel_gradient_descent.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/optim/stable_adam.py` & `zetascale-2.4.6/zeta/optim/stable_adam.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/bitlinear.py` & `zetascale-2.4.6/zeta/quant/bitlinear.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/half_bit_linear.py` & `zetascale-2.4.6/zeta/quant/half_bit_linear.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/lfq.py` & `zetascale-2.4.6/zeta/quant/lfq.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/niva.py` & `zetascale-2.4.6/zeta/quant/niva.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/qlora.py` & `zetascale-2.4.6/zeta/quant/qlora.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/qmoe.py` & `zetascale-2.4.6/zeta/quant/qmoe.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/quick.py` & `zetascale-2.4.6/zeta/quant/quick.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/residual_vq.py` & `zetascale-2.4.6/zeta/quant/residual_vq.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/quant/ste.py` & `zetascale-2.4.6/zeta/quant/ste.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/__init__.py` & `zetascale-2.4.6/zeta/rl/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/actor_critic.py` & `zetascale-2.4.6/zeta/rl/actor_critic.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/dpo.py` & `zetascale-2.4.6/zeta/rl/dpo.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/hindsight_replay.py` & `zetascale-2.4.6/zeta/rl/hindsight_replay.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/language_reward.py` & `zetascale-2.4.6/zeta/rl/language_reward.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/ppo.py` & `zetascale-2.4.6/zeta/rl/ppo.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/priortized_replay_buffer.py` & `zetascale-2.4.6/zeta/rl/priortized_replay_buffer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/priortized_rps.py` & `zetascale-2.4.6/zeta/rl/priortized_rps.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/reward_model.py` & `zetascale-2.4.6/zeta/rl/reward_model.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/sumtree.py` & `zetascale-2.4.6/zeta/rl/sumtree.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/rl/vision_model_rl.py` & `zetascale-2.4.6/zeta/rl/vision_model_rl.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/__init__.py` & `zetascale-2.4.6/zeta/structs/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/auto_regressive_wrapper.py` & `zetascale-2.4.6/zeta/structs/auto_regressive_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/clip_encoder.py` & `zetascale-2.4.6/zeta/structs/clip_encoder.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/efficient_net.py` & `zetascale-2.4.6/zeta/structs/efficient_net.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/encoder_decoder.py` & `zetascale-2.4.6/zeta/structs/encoder_decoder.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/hierarchical_transformer.py` & `zetascale-2.4.6/zeta/structs/hierarchical_transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/local_transformer.py` & `zetascale-2.4.6/zeta/structs/local_transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/multi_modal_projector.py` & `zetascale-2.4.6/zeta/structs/multi_modal_projector.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/simple_transformer.py` & `zetascale-2.4.6/zeta/structs/simple_transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/simple_vision_encoder.py` & `zetascale-2.4.6/zeta/structs/simple_vision_encoder.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/transformer.py` & `zetascale-2.4.6/zeta/structs/transformer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/structs/transformer_block.py` & `zetascale-2.4.6/zeta/structs/transformer_block.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/tokenizers/gptx_tokenizer.py` & `zetascale-2.4.6/zeta/tokenizers/gptx_tokenizer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/tokenizers/llama_sentencepiece.py` & `zetascale-2.4.6/zeta/tokenizers/llama_sentencepiece.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/tokenizers/multi_modal_tokenizer.py` & `zetascale-2.4.6/zeta/tokenizers/multi_modal_tokenizer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/tokenizers/sentence_piece.py` & `zetascale-2.4.6/zeta/tokenizers/sentence_piece.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/tokenizers/tokenmonster.py` & `zetascale-2.4.6/zeta/tokenizers/tokenmonster.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/activation_checkpoint.py` & `zetascale-2.4.6/zeta/training/activation_checkpoint.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/dataloader.py` & `zetascale-2.4.6/zeta/training/dataloader.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/fsdp.py` & `zetascale-2.4.6/zeta/training/fsdp.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/galore.py` & `zetascale-2.4.6/zeta/training/galore.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/hive_trainer.py` & `zetascale-2.4.6/zeta/training/hive_trainer.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/parallel_wrapper.py` & `zetascale-2.4.6/zeta/training/parallel_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/scheduler.py` & `zetascale-2.4.6/zeta/training/scheduler.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/training/train.py` & `zetascale-2.4.6/zeta/training/train.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/__init__.py` & `zetascale-2.4.6/zeta/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/benchmark.py` & `zetascale-2.4.6/zeta/utils/benchmark.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/cuda_memory_wrapper.py` & `zetascale-2.4.6/zeta/utils/cuda_memory_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/cuda_wrapper.py` & `zetascale-2.4.6/zeta/utils/cuda_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/disable_logging.py` & `zetascale-2.4.6/zeta/utils/disable_logging.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/enforce_types.py` & `zetascale-2.4.6/zeta/utils/enforce_types.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/img_to_tensor.py` & `zetascale-2.4.6/zeta/utils/img_to_tensor.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/log_pytorch_op.py` & `zetascale-2.4.6/zeta/utils/log_pytorch_op.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/main.py` & `zetascale-2.4.6/zeta/utils/main.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/module_device.py` & `zetascale-2.4.6/zeta/utils/module_device.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/params.py` & `zetascale-2.4.6/zeta/utils/params.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/save_load_wrapper.py` & `zetascale-2.4.6/zeta/utils/save_load_wrapper.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/text_to_tensor.py` & `zetascale-2.4.6/zeta/utils/text_to_tensor.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/verbose_execution.py` & `zetascale-2.4.6/zeta/utils/verbose_execution.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/zeta/utils/vision_utils.py` & `zetascale-2.4.6/zeta/utils/vision_utils.py`

 * *Files identical despite different names*

### Comparing `zetascale-2.4.5/setup.py` & `zetascale-2.4.6/setup.py`
...
@@ -276,9 +276,9 @@
 Backlog\nHelp us accelerate our backlog by supporting us financially! Note,
 we\'re an open source corporation and so all the revenue we generate is through
 donations at the moment ;)\n\n_[_h_t_t_p_s_:_/_/_p_o_l_a_r_._s_h_/_e_m_b_e_d_/_f_u_n_d_-_o_u_r_-
 _b_a_c_k_l_o_g_._s_v_g_?_o_r_g_=_k_y_e_g_o_m_e_z_]\n\n\n# License \n- Apache\n', 'author': 'Zeta Team',
 'author_email': 'kye@apac.ai', 'maintainer': 'None', 'maintainer_email':
 'None', 'url': 'https://github.com/kyegomez/zeta', 'packages': packages,
...
### Comparing `zetascale-2.4.5/PKG-INFO` & `zetascale-2.4.6/PKG-INFO`
